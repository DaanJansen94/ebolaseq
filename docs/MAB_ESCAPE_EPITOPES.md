...
Literature GP epitopes mapped to **UniProt Q05320** positions and **2014 Makona** amino acids ([KJ660346.2](https://www.ncbi.nlm.nih.gov/nuccore/KJ660346.2)) for sequence comparison. Details: [Coordinate system](#coordinate-system).

## mAb114 (Ebanga / ansuvimab)

GP1 receptor-binding head and glycan cap (approved EVD therapeutic).
...
| 274 | I | GP1 | Glycan cap | I274M | 1, 2 |
| 275 | W | GP1 | Glycan cap | W275L | 1, 2 |
...
310-pocket mAb. **Same GP epitope as parental ADI-15946** (table below). **ADI-15946** potently neutralizes EBOV and BDBV but lacks neutralizing and protective activity against SUDV (Bornholdt et al., Nat Struct Mol Biol 2019). **ADI-23774** is affinity-matured from ADI-15946 (yeast display) to improve SUDV GP binding—not a new GP footprint. MBP134 breadth = **ADI-15878** + **ADI-23774** (two non-overlapping sites).

**K510:** ADI-15946 heavy chain contacts the conserved **K510** (GP2 N-terminus). **K510E** abolishes binding/neutralization (first described as escape from BDBV neutralization; same substitution confirmed on EBOV GP in Bornholdt et al. 2019). Listed at position 510 below and in [escape catalogue](#catalogued-escape-mutations).

| Pos (Q05320) | Makona 2014 aa | GP subunit | Region | Proven escape mutants | Ref |
|-------------:|---------:|:----------:|--------|----------------------|:---:|
| 71 | E | GP1 | 310 helix — contact (GPCL) | — | 1 |
| 72 | G | GP1 | 310 helix — contact (GPCL) | — | 1 |
| 73 | N | GP1 | 310 helix — contact (GPCL) | — | 1 |
| 74 | G | GP1 | 310 helix — contact (GPCL) | — | 1 |
| 75 | V | GP1 | 310 helix — contact (GPCL) | — | 1 |
| 287 | E | GP1 | β17–β18 loop — competes (GPFL) | — | 1 |
| 288 | W | GP1 | β17–β18 loop — competes (GPFL) | — | 1 |
| 289 | A | GP1 | β17–β18 loop — competes (GPFL) | — | 1 |
| 290 | F | GP1 | Mimicked by CDR H3 (not in GPCL) | — | 1 |
| 291 | W | GP1 | Mimicked by CDR H3 (not in GPCL) | W291R | 1 |
| 292 | E | GP1 | Mimicked by CDR H3 (not in GPCL) | — | 1 |
| 510 | K | GP2 | GP2 N-term — HC contact; K510E escape | K510E | 1 |
...
3. Wec et al., Cell Host Microbe 2019 — **MBP134** cocktail (ADI-15878 + ADI-23774) ([10.1016/j.chom.2018.12.004](https://doi.org/10.1016/j.chom.2018.12.004))
4. Bornholdt et al., Cell Host Microbe 2019 — **MBP134AF** (same mAbs, afucosylated Fc; NHP efficacy) ([10.1016/j.chom.2018.12.005](https://doi.org/10.1016/j.chom.2018.12.005))

*Refs 3–4: product names for the two-mAb mix, not extra epitope sites. Rows 287–292: full-length GP only.*

## Catalogued escape mutations

| Mutation | Pos | Change | GP subunit | Linked mAb | Product(s) | Region | Ref |
|----------|----:|--------|:----------:|------------|------------|--------|:---:|
| P116H | 116 | P→H | GP1 | mAb114, REGN3471 | Ebanga, Inmazeb | GP1 head / RBS | 1 |
| G118E | 118 | G→E | GP1 | mAb114, REGN3471 | Ebanga, Inmazeb | GP1 head / RBS | 1 |
| G118R | 118 | G→R | GP1 | mAb114, REGN3471 | Ebanga, Inmazeb | GP1 head / RBS | 1 |
| T144M | 144 | T→M | GP1 | mAb114, REGN3471 | Ebanga, Inmazeb | GP1 head / RBS | 1 |
| I274M | 274 | I→M | GP1 | REGN3471 | Inmazeb | Glycan cap | 2 |
| W275L | 275 | W→L | GP1 | REGN3471 | Inmazeb | Glycan cap | 2 |
| G528R | 528 | G→R | GP2 | REGN3479 | Inmazeb | IFL / GP base | 3 |
| N563Y | 563 | N→Y | GP2 | REGN3479 | Inmazeb | HR1 glycan | 3 |
| G528E | 528 | G→E | GP2 | ADI-15878 | MBP134 | IFL | 4 |
| G528S | 528 | G→S | GP2 | ADI-15878 | MBP134 | IFL | 4 |
| K510E | 510 | K→E | GP2 | ADI-15946, ADI-23774 | MBP134 | GP2 N-term / 310 pocket (BDBV escape; EBOV confirmed) | 5 |
...
5. Bornholdt et al., Nat Struct Mol Biol 2019 — K510E (BDBV escape; EBOV GP) ([10.1038/s41594-019-0191-4](https://doi.org/10.1038/s41594-019-0191-4))

*Used by ebolaseq `mab-escape-report` vs Makona reference.*
...
- Primary structures: REGN-EB3 escape on Makona; mAb114 / ADI-15946 crystals on Mayinga (= same indices); ADI-15878 contacts from Murin 2018 Table S2 on **EBOV/Mak** cryo-EM.
